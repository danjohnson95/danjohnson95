---
title: Multilingual Mastery with Laravel
...
- If you're using Laravel Vapor to deploy your application, you may need to take some additional steps to support multiple locales. [I've written a blog post](https://danjohnson.xyz/en/blog/localisation-in-laravel-vapor) that steps you through what you need to do, and explains why.
